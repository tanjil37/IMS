...
<h1 class="text-center my-4 py-3 text-info text-uper" id="title">Inventory Management System</h1>
            ...
            <div class="container-fluid">
                <form method="post" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <input name="email" id="email" type="email" class="form-control rounded-0"
                            placeholder="Email address" autofocus=""
                            value="<?= isset($_POST['email']) ? $_POST['email'] : '' ?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="password" class="control-label">Password</label>
                        <input type="password" class="form-control rounded-0" id="password" name="pwd"
